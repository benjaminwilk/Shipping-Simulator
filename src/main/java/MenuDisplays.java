...
public class MenuDisplays{
	...
	private static final String[] portNames = {"Long Beach", "Sydney", "Hong Kong"};
	...
	private static final String[] containerMenu = {"Check Container Prices", "Display Loaded Containers", "Load Containers", "Unload Containers", "Examine Containers", "Go Back"};

	private static final String[] shoreOptionMenu = {"Check Weather Report", "Manage Crewmembers", "Check Ship Status", "Refuel Ship", "Check Port Prices", "Visit Hotel", "Go Back"};

	private static final String[] hotelOptions = {"Meet with Team", "Spend One Day Ashore", "Save game", "Load Game"};
	...
	public static String[] GetHotelOptions(){
		return hotelOptions;
	}
	...
	public static String GetPortName(int passedValue){
		return portNames[passedValue - 1];
	}
	...
	public static String[] getSailorSkills(){
		return sailorSkills;
	}

	public static int getSailorSkillCount(){
		return sailorSkills.length;
	}

	public static String getSailorSkills(int passedValue){
		return sailorSkills[passedValue];
	}
