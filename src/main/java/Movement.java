...
public class Movement{
	...
	private LongitudeLatitude DeparturePortLongitudeLatitude;
	private LongitudeLatitude ArrivalPortLongitudeLatitude;
	...
	public void iteration(Boat playerObject, PortChoice pc){
		this.DeparturePortLongitudeLatitude = new LongitudeLatitude(pc.getCurrentPort());
		this.ArrivalPortLongitudeLatitude = new LongitudeLatitude(pc.getDestinationPort());
		ConvertPortNameToCoordinates();
		
		this.MovementDistanceCalculation = new DistanceCalculation(this.DeparturePortLongitudeLatitude, this.ArrivalPortLongitudeLatitude);
